...
input=(
  'mrcatp' ' waitForHw; roslaunch mrcatp mrcatp.launch
  '
  'mrcatp' ' waitForHw; roslaunch area_monitoring_controller tf_publisher.launch
  '
  'activation' 'rosservice call /mrcatp_activate'
  'rviz' 'rviz -d ~/manuel_7_drones.rviz
  '
)
